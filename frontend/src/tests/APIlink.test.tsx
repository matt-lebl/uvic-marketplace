...
import {ErrorResponse, ListingRequest, ListingResponse} from '../interfaces';
...
describe('POST', () => {
    ...
    it('/Listings/createListing should satisfy OpenAPI spec', async () => {
        const testURL:string ='/Listings/createListing';

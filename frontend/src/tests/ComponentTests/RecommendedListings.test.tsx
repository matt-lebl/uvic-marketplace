...
//         render(<RecommendedListings />);
//         await waitFor(() => expect(mockAPIGet).toHaveBeenCalledTimes(2)); //due to some settings, such as react-strict, the component is loaded twice, which causes this to trigger more than once
...
//     //     await waitFor(() => expect(mockAPIGet).toHaveBeenCalledTimes(3), { timeout: 2500 });

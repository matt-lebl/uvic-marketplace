...
const nullorg: OrgEntity = {
  ...
  logoUrl:
    'https://plus.unsplash.com/premium_vector-1719413717708-4205e5cbe61c?q=80&w=2360&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  donated: 5,
  received: true,
}
...
const nullresponse: CharityEntity = {
  ...
  endDate: '01/09/24',
  imageUrl:
    'https://plus.unsplash.com/premium_vector-1682298589041-29ca4c47bebb?q=80&w=2124&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%',
...
export default function Events() {
  const [curCharityEvent, setCurCharityEvent] =
    useState<CharityEntity>(nullresponse)

...
describe('<Searchbox />', () => {
  ...
  it('displays placeholder text correctly', () => {
    ...
    const { getByPlaceholderText } = render(
      <Searchbox id="searchbox" placeholder={placeholderText} submit={() => {}} />
    );
  ...
  it('calls submit function when form is submitted', () => {
    ...
    const { getByRole } = render(<Searchbox id="searchbox" submit={mockSubmit} />);
  ...
  it('calls submit function when search button is clicked', () => {
    const mockSubmit = jest.fn();
    const { getByLabelText } = render(<Searchbox id="searchbox" submit={mockSubmit} />);
